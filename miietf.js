...
function renderLoop(data, airPerformances) {
  ...
  dataMappingsUpdated.forEach(_ref => {
    let {
      elementClass,
      data
    } = _ref;
      ...
      if (elementClass === ".holding-list") {
        ...
        if (holdingRows) {
          ...
          data.forEach((item, index) => {
            ...
            const html = "\n                        <div class=\"div-block-410 _2\">\n                            <svg height=\"8\" width=\"8\" xmlns=\"http://www.w3.org/2000/svg\">\n                                <circle r=\"4\" cx=\"4\" cy=\"4\" fill=\"".concat(PIE_COLORS_NEW[index], "\"></circle>\n                            </svg>\n                        </div>\n                        <div class=\"table-box _2 sectors\">\n                            <div class=\"table-data name sectors\"><strong class=\"bold-text\">").concat(item.key, "<br></strong></div>\n                        </div>\n                        <div class=\"table-box _3\">\n                            <div class=\"table-data name\">").concat(returnVal.trim(), "%<br></div>\n                        </div>\n                        ");
            row.innerHTML = html;
        ...
        if (weightedRows) {
          data.forEach((item, index) => {
            ...
            const row = document.createElement('div');
            row.classList.add('table-row-2');
            const html = "\n                            <div class=\"div-block-410 _2\">\n                                <svg height=\"8\" width=\"8\" xmlns=\"http://www.w3.org/2000/svg\">\n                                    <circle r=\"4\" cx=\"4\" cy=\"4\" fill=\"".concat(PIE_COLORS_NEW[index], "\"></circle>\n                                </svg>\n                            </div>\n                            <div class=\"table-box _2 sectors\">\n                                <div class=\"table-data name sectors\"><strong class=\"bold-text\">").concat(item.key, "<br></strong></div>\n                            </div>\n                            <div class=\"table-box _2 sectors\">\n                                <div class=\"table-data name sectors\"><strong class=\"bold-text\">").concat(item.value.miietf, "%<br></strong></div>\n                            </div>\n                            <div class=\"table-box _2 sectors\">\n                                <div class=\"table-data name sectors\"><strong class=\"bold-text\">").concat(item.value.kmi30, "%<br></strong></div>\n                            </div>\n                            <div class=\"table-box _3\">\n                                <div class=\"table-data name\">").concat(item.value.weight, "%<br></div>\n                            </div>\n                        ");
            row.innerHTML = html;
  ...
  if ((distributions === null || distributions === void 0 ? void 0 : distributions.length) > 0) {
    ...
    if (distributionBodyRow) {
      distributions.forEach(data => {
        ...
        const html = "\n                <div class=\"table-box _2\">\n                    <div class=\"table-data name\"><strong class=\"bold-text\">".concat(data.payoutDate ? data.payoutDate.split(' ')[0] : '-', "<br></strong></div>\n                </div>\n                <div class=\"table-box _3\">\n                    <div class=\"table-data name\">").concat(data.payoutPerUnit.toFixed(3) || '-', "</div>\n                </div>\n                <div class=\"table-box _3\">\n                    <div class=\"table-data name\">").concat(data.exNav.toFixed(4) || '-', "</div>\n                </div>\n                <div class=\"table-box _3\">\n                    <div class=\"table-data name\">").concat(data.yield.toFixed(2) || '-', "%</div>\n                </div>\n                ");
  ...
  if (performances) {
    ...
    if (performanceContentArea) {
      ...
      while (performanceRowsDiv.lastChild) {
        if (performanceRowsDiv.lastChild.classList.contains('headers')) break;else performanceRowsDiv.removeChild(performanceRowsDiv.lastChild);
      }
      performances.forEach(data => {
        // console.log(data)
        ...
        const row = document.createElement('div');
        row.classList.add('table-row');
        const html = "<div class=\"div-block-406 _2\"><img width=\"16\" src=\"https://cdn.prod.website-files.com/647f1d0084dd393f468d58a6/66668a5b5b769b78a21062ab_Vectors-Wrapper.svg\" alt=\"\" class=\"image-79\"></div><div class=\"table-box _2\"><div class=\"table-data name\"><strong class=\"bold-text\">".concat((data === null || data === void 0 ? void 0 : data.name) || '-', "<br></strong></div></div><div class=\"table-box _3\"><div class=\"table-data name\">").concat(data.mtd || '-', "</div></div><div class=\"table-box _3\"><div class=\"table-data name\">").concat(data.ytd || '-', "</div></div><div class=\"table-box _3\"><div class=\"table-data name\">").concat(data.days90 || '-', "</div></div><div class=\"table-box _3\"><div class=\"table-data name\">").concat(data.days365 || '-', "</div></div>");
  ...
  if (currentAssetAllocation) {
    ...
    if (portfolioDataContainer) {
      ...
      currentAssetAllocation.forEach((data, index) => {
        ...
        const html = "\n                <div class=\"table-content-area\">\n                    <div style=\"display: flex; gap: 14px\">\n                        <div class=\"div-block-101\" style=\"display: flex;\">\n                            <svg style=\"margin-right: 6px\" xmlns=\"http://www.w3.org/2000/svg\" width=\"7\" height=\"13\" viewBox=\"0 0 7 13\" fill=\"none\"><circle cx=\"3.5\" cy=\"9.04102\" r=\"3\" fill=".concat(selectedColor, "></circle></svg>\n                        <div>\n                        <div class=\"text-block-37\">").concat(data.key, "</div>\n                        <div class=\"text-block-38\">").concat(returnVal, "%</div>\n                    </div>\n                </div>\n                ");
        row.innerHTML = html;
...
async function fetchData(airPerformances) {
  ...
  try {
    var _fundInfo, _fundInfo2, _fundInfo3, _fundInfo4, _overview;
    //////////////
    // AIRTABLE //
    //////////////
    ...
    // MAHANANA BACKEND //
    //////////////////////
    const response = await fetch("".concat(mahaanaWealthCashFund, "/api/CashFund/miietf"));
    if (!response.ok) {
    ...
    expense_ratio_mtd = ((_fundInfo = fundInfo) === null || _fundInfo === void 0 ? void 0 : _fundInfo.monthlyTotalExpenseRatio) > 0 ? "".concat((_fundInfo2 = fundInfo) === null || _fundInfo2 === void 0 ? void 0 : _fundInfo2.monthlyTotalExpenseRatio, "%") : 'N/A';
    expense_ratio_ytd = ((_fundInfo3 = fundInfo) === null || _fundInfo3 === void 0 ? void 0 : _fundInfo3.yearlyTotalExpenseRatio) > 0 ? "".concat((_fundInfo4 = fundInfo) === null || _fundInfo4 === void 0 ? void 0 : _fundInfo4.yearlyTotalExpenseRatio, "%") : 'N/A';
    const contentMapping = {
      'asset-name': (_overview = overview) === null || _overview === void 0 ? void 0 : _overview.name,
      ...
      'micf-mtd': "".concat(monthToDateExpense.key.toFixed(2), "%"),
      // 'mtd-date': `as of ${moment(monthToDateExpense.value).format('D MMM YYYY')}`,
      'mtd-date': "as of ".concat(moment(fmrDate).format('D MMM YYYY')),
      'nav-price': "".concat(overview.navPerUnit.includes('.') ? Number(overview.navPerUnit).toFixed(4) : Number(overview.navPerUnit)),
      // 'nav-date': `as of ${moment(overview.navDate, 'YYYY/MM/DD').format('D MMM YYYY')}`,
      'nav-date': "as of ".concat(moment(navDate, 'YYYY/MM/DD').format('D MMM YYYY')),
      ...
      'i-nav': "".concat(overview.navPerUnit.includes('.') ? Number(overview.navPerUnit).toFixed(4) : Number(overview.navPerUnit))
    };
    ...
    if (offeringDocumentList.length > 0) {
      offeringDocumentWrapper.href = "".concat(mahaanaWealthCashFund, "/api/Document/").concat(offeringDocumentList[offeringDocumentList.length - 1].key.split('.')[0]);
...
async function getFundData2(duration) {
  ...
  if (totalReturnDate) {
    totalReturnDate.textContent = "as of ".concat(moment(lastDate, 'DD/MM/YYYY').format('D MMM YYYY'));
  }
